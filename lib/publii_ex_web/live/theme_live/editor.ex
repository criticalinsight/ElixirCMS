defmodule PubliiExWeb.ThemeLive.Editor do
  ...
  defp _gradient_for("nebula"), do: "from-indigo-900 to-purple-900"
  defp _gradient_for("kinetic"), do: "from-yellow-400 to-orange-500"
  defp _gradient_for("zenith"), do: "from-stone-200 to-stone-300"
  defp _gradient_for("postos"), do: "from-gray-100 to-white text-black"
  defp _gradient_for("monastery"), do: "from-zinc-100 to-zinc-200 text-black border-zinc-300"
  defp _gradient_for("sushism"), do: "from-red-600 to-black text-white"
  defp _gradient_for("humane"), do: "from-orange-50 to-amber-50 text-stone-800 border-amber-100"
  defp _gradient_for("ordinary"), do: "bg-white border-black text-black"
  defp _gradient_for("museum"), do: "from-orange-200 to-rose-200 text-black border-black"
  defp _gradient_for("lime"), do: "bg-slate-900 border-lime-400 text-lime-400"
  defp _gradient_for(_), do: "from-slate-700 to-slate-800"
end
